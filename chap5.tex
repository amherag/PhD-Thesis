...
Common Lisp. % Add a link to the Github Repo - Mario
...
exchange markets. % More detail? - Mario
...
the interval $[0, 2]$. % Values in the belief vector continue to be random or
...
the system, and an increased risk of overtraining the system. % I like 'overfitting' more 
...
are closer to the real market prices. % Briefly justify the use of a GA - Mario
...
The roulette wheel selection algorithm was chosen arbitrarily. % Not so much, 
