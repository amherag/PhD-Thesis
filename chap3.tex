...
%% other technicques to forecast
\cite{Cai2013} forecast. fuzzy time series and genetic algorithm. uses GA to optimize. TAIEX is used as
...
%% one last choise is multi-agents
