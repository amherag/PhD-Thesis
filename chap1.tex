...
known as complex systems. % Add a reference to an important paper on CS.
...
price is to use fundamental analysis \ref{}. This type of analysis takes into % Reference missing
account information that you can gather from the factors that influence the % Can we say knowledge instead of information?
...
%% Move it to the point where you are going to state the structure or even remove it 
...
The objective of this thesis is to propose a novel series of approaches on how % series of approaches -> Methodology 
% You are proposing a new method  
...
insights to perform better decisions while trading such markets. These % trading IN such markets? or is jargon?
...
very complex systems. % Also there is the paper from Puga, please add a reference. 
